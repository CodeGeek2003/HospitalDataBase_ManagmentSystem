...
ASSETS_PATH = OUTPUT_PATH / Path(r"assets/HospitalManager_ii_gui")
...
def open_hos_2_gui():
    ...
    sql_command="SELECT ? FROM HospitalManager WHERE hospital_manager_id = ?"
    gl.u_dob=None
    window.resizable(False, False)
    window.mainloop()
#TODO: Add the code to display the labels of the Hospital Manager